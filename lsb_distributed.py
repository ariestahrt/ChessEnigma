...
class LSBSteg():
    def __init__(self, im):
        ...
        print("part_height:", self.part_height)
        print("part_width:", self.part_width)
    ...
    def next_slot2(self):#Move to the next slot were information can be taken or put
        if self.cur_width_part == self.width_part-1:
            self.cur_width_part = 0
            if self.cur_height_part == self.height_part-1:
                self.cur_height_part = 0
                ...
                self.cur_height_part += 1
                self.curheight = self.cur_height_part * self.part_height
        else:
            self.cur_width_part += 1
            self.curwidth = self.cur_width_part * self.part_width

        print("curwidth:", self.curwidth)
        print("curheight:", self.curheight)
        print("curchan:", self.curchan)
        print("cur_width_part:", self.cur_width_part)
        print("cur_height_part:", self.cur_height_part)
...
def main():
    in_f = "experiments/board_1.png"
    out_f = "experiments/board_1_embeded.png"
    ...
    in_f = "experiments/board_1_embeded.png"
    out_f = "experiments/board_1_extracted.pkl"
    in_img = cv2.imread(in_f)
    steg = LSBSteg(in_img)
    res = steg.decode_binary()
